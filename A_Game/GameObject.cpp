...
void GameObject::CreateSphere(int LatLines, int LongLines)
{
...
bool GameObject::InitCube()
{
	...
	D3DCompileFromFile(L"Shader/CubeShader.fx", 0, 0, "VS", "vs_5_0", 0, 0, &VS_Buffer, &compilationMsgs);
	D3DCompileFromFile(L"Shader/CubeShader.fx", 0, 0, "PS", "ps_5_0", 0, 0, &PS_Buffer, &compilationMsgs);
...
bool GameObject::InitMd5()
{
	...
	D3DCompileFromFile(L"MD5Shader.fx", 0, 0, "VS", "vs_5_0", 0, 0, &VS_Buffer, &compilationMsgs);
	D3DCompileFromFile(L"MD5Shader.fx", 0, 0, "PS", "ps_5_0", 0, 0, &PS_Buffer, &compilationMsgs);
...
bool GameObject::InitSky()
{
	...
	hr = dev->CreateShaderResourceView(res.Get(), &SMViewDesc, &smrv);
...
void GameObject::UpdateMatrix()
{
	...
	if (mType == SDKMESH)
	{
		Scale = XMMatrixScaling(25.22f, 25.22f, 25.22f);
		smilesWorld = Scale * World;
	}
...
void GameObject::DrawSdkmesh()
{
	m_model->Draw(con, *m_states, smilesWorld, camView,
		camProjection);
}
